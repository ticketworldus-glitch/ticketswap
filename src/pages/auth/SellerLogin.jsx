...
//         (data.role === "seller" ||
//           data.isSeller === true ||
//           data.role === "admin"); // admin can also access seller panel if you want

//       if (!isSeller) {
//         await signOut(auth);
//         setError("This account is not a seller. Contact admin to upgrade.");
//         setLoading(false);
//         return;
//       }
...
//           <h1 className="text-xl font-semibold">Seller login</h1>
//           <p className="text-xs text-slate-400">
//             Log in to manage your listings and sales.
//           </p>
//         </div>
...
//           >
//             {loading ? "Checking role..." : "Log in as seller"}
//           </button>
//         </form>
