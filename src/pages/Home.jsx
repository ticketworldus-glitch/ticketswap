...
//     return dates.includes(tomorrowStr);
//   }
...
//       {/* HERO */}
//       <section className="relative overflow-hidden rounded-3xl bg-slate-950 border border-slate-800">
//         <div className="absolute inset-0">
//           <div className="h-full w-full bg-gradient-to-br from-emerald-500/20 via-slate-900 to-blue-500/20" />
...
//             <button
//               type="button"
//               className="md:hidden inline-flex items-center justify-center h-9 w-9 rounded-full bg-slate-900 border border-slate-700 text-slate-100"
...
//               className="flex items-center bg-slate-900/95 border border-slate-700 rounded-full px-4 py-2 gap-2 shadow-lg shadow-black/30"
//             >
//               <Search className="w-4 h-4 text-slate-400" />
//               <input
//                 placeholder="Search for an event, artist, venue or city"
//                 className="bg-transparent flex-1 text-sm text-slate-100 placeholder:text-slate-500 outline-none"
//                 value={searchTerm}
...
//               <form
//                 onSubmit={handleSearchSubmit}
//                 className="bg-slate-950/95 border border-slate-700 rounded-2xl p-3 space-y-2"
//               >
...
//                 <button
//                   type="submit"
//                   className="w-full mt-2 px-4 py-2 rounded-full bg-emerald-600 text-xs font-medium"
//                 >
//                   Search events
//                 </button>
//               </form>
...
//                 </div>
//                 <p className="text-slate-400">17,000+ fan reviews</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//         <div className="flex items-center gap-6 text-xs border-b border-slate-800 pb-2">
//           <button className="pb-2 border-b-2 border-emerald-500 text-slate-100 font-medium">
//             Discover
//           </button>
//           <button className="pb-2 text-slate-400 hover:text-slate-100">
//             For you
//           </button>
//           <button className="pb-2 text-slate-400 hover:text-slate-100">
//             Following
...
//             More than <span className="text-emerald-400">17,000,000</span>{" "}
//             happy fans from over <span className="text-emerald-400">40</span>{" "}
//             countries
//           </h2>
//         </div>

//         <div className="grid md:grid-cols-3 gap-4 text-xs">
//           <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 rotate-[-1.5deg]">
//             <p className="font-semibold text-slate-100 mb-1">Lynsey</p>
//             <p className="text-slate-300">
//               “I was panicking they wouldn&apos;t sell, but 24 hours later
//               they went to a happy customer. Such a great site.”
//             </p>
//           </div>
//           <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 rotate-[1.5deg]">
//             <p className="font-semibold text-slate-100 mb-1">Rob</p>
//             <p className="text-slate-300">
//               “38 seconds is all it took to sell my ticket. Hope the buyer
//               enjoys it as much as I would have.”
//             </p>
//           </div>
//           <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 hidden md:block">
//             <p className="font-semibold text-slate-100 mb-1">Mina</p>
//             <p className="text-slate-300">
//               “Super smooth experience buying last-minute seats. Instant
    ...
    >
      ...
      <motion.section className="space-y-4" variants={fadeUp}>
        ...
        <div className="grid md:grid-cols-3 gap-4 text-xs">
          ...
          <motion.div
            className="bg-white border border-slate-200 rounded-2xl p-4 hidden md:block shadow-sm dark:bg-slate-900 dark:border-slate-800"
