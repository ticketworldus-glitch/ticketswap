...
//     // If current expanded ticket is not in the visible list, or none set yet,
//     // default to the first visible ticket
...
//       {/* STEP 1 – PREFERENCES */}
//       {step === 1 && (
//         <section className="bg-white border border-slate-200 rounded-2xl p-4 space-y-4 max-w-md shadow-sm dark:bg-slate-900 dark:border-slate-800">
//           <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">
//             Ticket preferences
//           </h2>
//           <div>
//             <label className="text-xs text-slate-600 block mb-1 dark:text-slate-300">
//               Number of tickets
//             </label>
//             <input
//               type="number"
...
//                 setSeatCount(v);
//                 setSelectedTicketIds([]); // reset
//                 setExpandedTicketId(null);
//               }}
//               className="w-24 bg-white border border-slate-300 rounded px-2 py-1 text-sm text-slate-900 dark:bg-slate-950 dark:border-slate-700 dark:text-slate-100"
//             />
//           </div>
...
//                   setExpandedTicketId(null);
//                 }}
//                 className="w-full bg-white border border-slate-300 rounded px-3 py-2 text-xs text-slate-900 dark:bg-slate-950 dark:border-slate-700 dark:text-slate-100"
//               >
    ...
    <div className="relative max-w-5xl mx-auto px-4 py-8 space-y-6">
      ...
      {step === 1 && (
        <div className="fixed inset-0 z-30 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white border border-slate-200 p-5 shadow-lg dark:bg-slate-900 dark:border-slate-800">
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                {/* Optional: close without changing step (but keeping step=1 blocks ticket list)
                    So we only use "Continue" to move to selection */}
                <button
                  onClick={() => setStep(2)}
                  className="w-full mt-1 px-4 py-2 rounded-full bg-emerald-600 text-xs font-medium text-white"
                >
                  Continue to seat selection
                </button>
              </div>
