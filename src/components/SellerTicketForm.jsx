...
//       setForm((f) => ({ ...f, locationId: "" }));
//     }
//   }, [form.eventId]); // eslint-disable-line react-hooks/exhaustive-deps
...
//       <div className="space-y-2 text-xs">
//         <label className="text-slate-300">Select location for this ticket</label>
//         <select
//           name="locationId"
...
//           required
//           className="w-full bg-slate-900 border border-slate-700 rounded px-3 py-2 text-xs disabled:opacity-50"
//         >
//           <option value="">
...
//               {loc.name}{" "}
//               {loc.type ? `(${loc.type === "parking" ? "Parking" : "Event"})` : ""}
//             </option>
//           ))}
//         </select>
...
//         <div className="space-y-1">
//           <label className="text-slate-300">Number of tickets</label>
//           <input
//             type="number"
//             name="ticketCount"
//             min={1}
...
//       {/* Ticket image + extra description */}
//       <div className="space-y-1 text-xs">
//         <label className="text-slate-300">
//           Ticket image URL (e.g. from Ticketmaster)
//         </label>
//         <input
//           name="ticketImageUrl"
